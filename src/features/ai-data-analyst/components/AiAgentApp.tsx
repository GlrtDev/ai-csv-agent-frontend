...
const AIAgentApp: React.FC = () => {
  ...
  const handleSendPrompt = async () => {
    ...
    try {
      const result = await handleSendPromptRequest(
        state.prompt,
        state.accessToken,
      ); // Pass the token
      setState({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4 sm:p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-center bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text"
          ...
          <div className="bg-gray-900/90 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-gray-700 shadow-lg space-y-4">
            ...
            state.result.data.length > 0 ? (
              ...
              <pre
                ...
                className="bg-black/50 text-green-400 p-4 rounded-md overflow-x-auto whitespace-pre-wrap"
              >
